...
$(document).ready(function(){
    ...
    $(".pageblock#fullscreen #slideposition ul").css('margin-left', (mainslider.totalSlides )*(-10));

    $(".slide#first").backstretch("images/2.jpg");
    $(".slide#sec").backstretch("images/3.jpg");
    $(".slide#thirth").backstretch("images/4.jpg");
    $(".slide#fourth").backstretch("images/5.jpg");
    $(".slide#fifth").backstretch("images/6.jpg");
